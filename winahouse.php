                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container ipad-width">
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a href="" class="fa fa-times close-icon pull-right"></a> <a href="" class="btn btn-primary random-btn random-btn3 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;3.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                ...
                                                                <div class="panel-body checkbox-body">
                                                                    ...
                                                                    <div class="table-responsive table-borderless">
                                                                        ...
                                                                        <a class="btn btn-primary random-btn5 random-btn">RANDOM</a>
                                                            ...
                                                            <ul class="draw-order-list">
                                                                ...
                                                                <li class="clearfix">
                                                                    <div class="col-md-1 col-xs-2 checkbox-padding">
                                                                        ...
                                                                        <div class="options">
                                                                            <label class="radio-inline">
                                                                                <input type="radio" name="optradio" value="4 draw"><img/>
                                                                            </label>
                                                                        </div>
