                    ...
                    <section class="main-section">
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">SINGLE GAMES</a></li>
                                <li><a data-toggle="tab" href="#menu1">SYSTEM GAMES</a></li>
                                <li><a data-toggle="tab" href="#menu2">GROUP PLAY</a></li>
                            </ul>
                                ...
                                <div id="home" class="tab-pane fade in active">
                                    ...
                                    <section>
                                        ...
                                        <section class="background-clr">
                                            ...
                                            <img src="images/ticket-ribbon.png" alt="" style="position:absolute">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="text">
                                                        <h4>PLAY LOTTO MAX ONLINE</h4>
                                                        <h1>&euro;47 300 000   </h1>
                                            ...
                                            <section class="background-clr1">
                                                ...
                                                <div class="row mobile-hide">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <buttton class="btn btn-primary quickpick-btn">QUICKPICK</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container ipad-width">
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a href="" class="fa fa-times close-icon pull-right"></a> <a class="btn btn-primary random-btn random-btn1 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a href="" class="fa fa-times close-icon pull-right"></a> <a class="btn btn-primary random-btn random-btn2 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a class="fa fa-times close-icon pull-right"></a> <a class="btn btn-primary random-btn random-btn3 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a class="fa fa-times close-icon pull-right"></a> <a class="btn btn-primary random-btn random-btn4 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                        ...
                                                        <div class="col-md-2 margin-increase">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1<a class="fa fa-times close-icon pull-right"></a> <a class="btn btn-primary random-btn random-btn5 mobile-display">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                                ...
                                                                <ul class="draw-order-list">
                                                                    ...
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-6">
                                                                            ...
                                                                            <h5 class="draw-head2 draw-1">€2.50</h5>
                                                                    ...
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-6">
                                                                            ...
                                                                            <h5 class="draw-head2 draw-2">€2.50</h5>
                                        ...
                                        <section class="background-clr">
                                            ...
                                            <section class="background-clr1">
                                                ...
                                                <div class="row mobile-hide">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <h2 class="pick-heading">Pick 5 or more Number</h2>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container ipad-width" style="padding:0">
                                                        ...
                                                        <div class="col-md-3 margin-increase2">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1 <a class="btn btn-primary random-btn random-btna1 mobile-display1">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                                                        ...
                                                        <div class="col-md-5 white-backgroun-system-game">
                                                ...
                                                <div class="row mobile-hide">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <h2 class="pick-heading">...And Pick 1 or more bonus number</h2>
                                                ...
                                                <div class="row mobile-hide">
                                                    ...
                                                    <div class="container" style="padding:0">
                                                        ...
                                                        <div class="col-md-5 white-backgroun-system-game2">
                                        ...
                                        <section class="background-clr">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="text">
                                                        <h4>PLAY LOTTO MAX LAND ONLINE</h4>
                                                        <h1>&euro;47 300 000  </h1>
                                                        <h5>DRAW ON THU 07:59 & SUN 07:59</h4>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container ipad-width" style="padding:0">
                                                        ...
                                                        <div class="col-md-3 margin-increase2">
                                                            ...
                                                            <div class="panel panel-default no-border">
                                                                <div class="panel-heading checkbox-head">Line 1 <a class="btn btn-primary random-btn random-btna2 mobile-display1">RANDOM</a> <span class="pull-right mobile-hide">&euro;2.50</span></div>
                                                                <div class="panel-body checkbox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading winning-stats">What are my chances of winning?</div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="win-stat-t-body">

                                                    <td>1</td>
                                                    <td>5+1</td>
                                                    <td class="white-clr">1:292 201 338</td>
                                                ...
                                                <tr class="win-stat-t-body">
                                                    ...
                                                    <td>2</td>
                                                    <td>5</td>
                                                    <td class="white-clr">1:11 688 053</td>
                                                ...
                                                <tr class="win-stat-t-body">
                                                    ...
                                                    <td>3</td>
                                                    <td>4+1</td>
                                                    <td class="white-clr">1:913 129</td>
                                                ...
                                                <tr class="win-stat-t-body">
                                                    ...
                                                    <td>4</td>
                                                    <td>4</td>
                                                    <td class="white-clr">1:36 525</td>
                                                ...
                                                <tr class="win-stat-t-body">
                                                    ...
                                                    <td>5</td>
                                                    <td>3+1</td>
                                                    <td class="white-clr">1:14 494</td>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading winning-stats">What our cutomer say</div>

                                <div class="panel-body height-equ">

                                    <h3 class="cust-review">"Best product in the world, highly recommended"</h3>
                                    

                                    <h4 class="cust-name">Tim o <a href="" class="pull-right">Read more ></a></h4>
